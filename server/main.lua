...
RegisterServerEvent("cxProperty:setPlayerToBucket")
AddEventHandler("cxProperty:setPlayerToBucket", function(propertyID)
    local _src = source
...
RegisterServerEvent("cxProperty:setPlayerToNormalBucket")
AddEventHandler("cxProperty:setPlayerToNormalBucket", function()
    local _src = source
    SetPlayerRoutingBucket(_src, 0)
end)

RegisterServerEvent("cxProperty:ExitInteract")
AddEventHandler("cxProperty:ExitInteract", function(propertyID)
    local _src = source
	...
	TriggerClientEvent("cxProperty:ExitProperty", _src, propertyID)
end)

RegisterServerEvent("cxProperty:EnteringInteract")
AddEventHandler("cxProperty:EnteringInteract", function(propertyType, propertyID, isVisit)
    local _src = source
	...
	TriggerClientEvent("cxProperty:EnteringProperty", _src, propertyType, propertyID, isVisit)
end)

RegisterServerEvent("cxProperty:openJobInteractionsMenu")
AddEventHandler("cxProperty:openJobInteractionsMenu", function()
    local _src = source 
    local xPlayer = ESX.GetPlayerFromId(_src)
	MySQL.Async.fetchAll("SELECT * FROM properties", {}, function(propertiesJobs)
		...
		TriggerClientEvent("cxProperty:OpenBuilderMenu", _src, propertiesJobs)
    end)
end)

RegisterServerEvent("cxProperty:OpenOwnerList")
AddEventHandler("cxProperty:OpenOwnerList", function(propertyID)
    local _src = source 
    local xPlayer = ESX.GetPlayerFromId(_src)
	TriggerClientEvent("cxProperty:OpenOwnerMenu", _src, Property[propertyID].players)
end)

RegisterServerEvent("cxProperty:AddProperty")
AddEventHandler("cxProperty:AddProperty", function(PropertyInfos)
    local _src = source
	local xPlayer = ESX.GetPlayerFromId(_src)
	...
	SetTimeout(250, function()
		MySQL.Async.fetchAll("SELECT * FROM properties", {}, function(allProperties)
			...
			TriggerClientEvent("cxProperty:refreshProperty", -1, nil, allProperties) 
		end)
	end)
end)

RegisterServerEvent("cxProperty:OwnedProperties")
AddEventHandler("cxProperty:OwnedProperties", function(PropertyID)
    local _src = source 
    local xPlayer = ESX.GetPlayerFromId(_src)
				...
				if #v.ownerList > 0 then 
					for t,b in pairs(v.ownerList) do 
						if v.propertyOwner == xPlayer.getIdentifier() or b.identifier == xPlayer.getIdentifier() then 
							TriggerClientEvent("cxProperty:OpenPropertyMenu", _src, true, propertyResult)
						else
							TriggerClientEvent("cxProperty:OpenPropertyMenu", _src, false, propertyResult)
						end
					end
				else
...
RegisterServerEvent("cxProperty:OwnedGarages")
AddEventHandler("cxProperty:OwnedGarages", function(PropertyID)
    local _src = source 
    local xPlayer = ESX.GetPlayerFromId(_src)
				...
				MySQL.Async.fetchAll("SELECT * FROM properties_vehicles WHERE propertyID = @propertyID", {
					...
					if propertyVehiclesResult[1] then 
						...
						if propertyOwner == xPlayer.getIdentifier() then 
							TriggerClientEvent("cxProperty:OpenGarageMenu", _src, true, propertyResult, propertyVehiclesResult)
						else
							TriggerClientEvent("cxProperty:OpenGarageMenu", _src, true, propertyResult, propertyVehiclesResult)
						end
					else
						if propertyOwner == xPlayer.getIdentifier() then 
							TriggerClientEvent("cxProperty:OpenGarageMenu", _src, true, propertyResult, nil)
						else
							TriggerClientEvent("cxProperty:OpenGarageMenu", _src, false, propertyResult, nil)
						end
					end
				end)
			end
...
RegisterServerEvent("cxProperty:GivePropertyToPlayer")
AddEventHandler("cxProperty:GivePropertyToPlayer", function(propertyID, xTarget)
	local _src = source
	local xPlayer = ESX.GetPlayerFromId(_src)
...
RegisterServerEvent("cxProperty:GetVehiclesProperties")
AddEventHandler("cxProperty:GetVehiclesProperties", function(PropertyID)
    local _src = source 
    local xPlayer = ESX.GetPlayerFromId(_src)
	MySQL.Async.fetchAll("SELECT * FROM owned_vehicles WHERE owner = @owner AND propertyID = @propertyID", {
		...
		MySQL.Async.fetchAll("SELECT * FROM properties_vehicles WHERE propertyID = @propertyID", {
			...
			TriggerClientEvent("cxProperty:OpenGestionGarageMenu", _src, ownedResult, propertiesVehiclesResult)
		end)
    end)
end)

RegisterServerEvent("cxProperty:InteractionsGarage")
AddEventHandler("cxProperty:InteractionsGarage", function(propertyID, vehicleInfos, Actions)
    local _src = source
	local xPlayer = ESX.GetPlayerFromId(_src)
	if Actions == 1 then 
			...
			SetTimeout(120, function()
				MySQL.Async.fetchAll("SELECT * FROM properties_vehicles WHERE propertyID = @propertyID", {
					...
					MySQL.Async.fetchAll("SELECT * FROM owned_vehicles WHERE owner = @owner AND propertyID = @propertyID", {
						...
						TriggerClientEvent("cxProperty:reloadVehicles", _src, vehicleResult, ownedResult)
					end)
				end)
...
RegisterServerEvent("cxProperty:AddVehicleIntoGarage")
AddEventHandler("cxProperty:AddVehicleIntoGarage", function(propertyID, CurrentVehicle, vehicleLabel)
    local _src = source
	local xPlayer = ESX.GetPlayerFromId(_src)
	MySQL.Async.fetchAll("SELECT * FROM properties_vehicles WHERE propertyID = @propertyID AND plate = @plate", {
		...
		if result[1] then
			...
			TriggerClientEvent("cxProperty:checkGarage", _src)
		else
...
RegisterServerEvent("cxProperty:UpdateStored")
AddEventHandler("cxProperty:UpdateStored", function (vehiclePlate, vehicleLabel)
	local _src = source
    local xPlayer = ESX.GetPlayerFromId(_src)
...
RegisterServerEvent("cxProperty:DeleteProperty")
AddEventHandler("cxProperty:DeleteProperty", function (propertyID)
	local _src = source
    local xPlayer = ESX.GetPlayerFromId(_src)
...
RegisterServerEvent("cxProperty:UpdateOwner")
AddEventHandler("cxProperty:UpdateOwner", function (propertyID)
	local _src = source
    local xPlayer = ESX.GetPlayerFromId(_src)
  	if propertyID ~= nil then
...
RegisterServerEvent("cxProperty:ActionsStorage")
AddEventHandler("cxProperty:ActionsStorage", function (propertyID, dataStorage, itemName, currentStorage, count, Type)
	local _src = source
    local xPlayer = ESX.GetPlayerFromId(_src)
				...
				MySQL.Async.fetchAll("SELECT * FROM properties WHERE propertyID = @propertyID", {
					...
					for k, v in pairs(propertyResult) do
						...
						for t,b in pairs(Property[v.propertyID].players) do 
							if b.id ~= nil then 
								TriggerClientEvent('cxProperty:reloadInfos', b.id, propertyResult)
							end
						end
					end
				end)
...
RegisterServerEvent("cxProperty:ActionsMoney")
AddEventHandler("cxProperty:ActionsMoney", function (propertyID, dataMoney, moneyType, count, Type, TypeActions)
	local _src = source
    local xPlayer = ESX.GetPlayerFromId(_src)
	count = math.floor(count)
	if Type == 1 then 
...
RegisterServerEvent("cxProperty:NotInProperty")
AddEventHandler("cxProperty:NotInProperty", function(playerSource)
	TriggerClientEvent("esx:showNotification", playerSource, "Le propriétaire n'est pas dans sa propriété.")
end)

RegisterServerEvent("cxProperty:DringDring")
AddEventHandler("cxProperty:DringDring", function(propertyOwner)
    local _src = source
	local xPlayer = ESX.GetPlayerFromId(_src)
	...
	TriggerClientEvent("cxProperty:DringDringReponse", xOwner.source, Sonnerie[_src])
	SetTimeout(30000, function()
		Sonnerie[_src] = nil
	end)
end)

RegisterServerEvent("cxProperty:AcceptDringDring")
AddEventHandler("cxProperty:AcceptDringDring", function(xOtherPlayer, propertyID)
    local _src = source
	local xPlayer = ESX.GetPlayerFromId(_src)
	...
	TriggerClientEvent("cxProperty:ReponsePerms", xOtherPlayer)
end)

RegisterServerEvent('cxProperty:Announce')
AddEventHandler('cxProperty:Announce', function(type, reason)
...
RegisterServerEvent("cxProperty:getInfos")
AddEventHandler("cxProperty:getInfos", function()
    local _src = source
	local xPlayer = ESX.GetPlayerFromId(_src)
	...
	SetTimeout(250, function()
		TriggerClientEvent("cxProperty:refreshProperty", _src, UserData, PropertiesData)
	end)
end)

RegisterServerEvent("cxProperty:addOwner")
AddEventHandler("cxProperty:addOwner", function(propertyID, ownerId, ownerData)
    local _src = source
	local xPlayer = ESX.GetPlayerFromId(_src)
	...
	SetTimeout(250, function()	
		...
		MySQL.Async.fetchAll("SELECT * FROM properties", {}, function(allProperties)
			...
			TriggerClientEvent("cxProperty:refreshProperty", ownerId, nil, allProperties) 
		end)
	end)
end) 

RegisterServerEvent("cxProperty:deleteOwner")
AddEventHandler("cxProperty:deleteOwner", function(propertyID, propertyIdentifier, ownerData)
    local _src = source
	local xPlayer = ESX.GetPlayerFromId(_src)
	...
	MySQL.Async.fetchAll("SELECT * FROM properties", {}, function(allProperties)
		...
		TriggerClientEvent("cxProperty:refreshProperty", xIdentifier.source, nil, allProperties) 
	end)
end)
